...
/// Music and voice settings APIs for the video call feature
class TXAudioEffectManager {
  ...
  /// **Parameters:**
  ///
  /// Default value: [TXVoiceReverbType.TXVoiceReverbType_0]. For more information, please see the definition of the [TXVoiceReverbType] parameter in `trtc_cloud_def`
  ...
  /// **Parameters:**
  ///
  /// `musicParam` Music parameter. For more information, please see the definition of the [AudioMusicParam] parameter
  ///
  /// **Return:**
  ///
  ...
  Future<void> setMusicPitch(int id, double pitch) {
    return _channel.invokeMethod(
        'setMusicPitch', {"id": id, "pitch": pitch.toString()});
  }
