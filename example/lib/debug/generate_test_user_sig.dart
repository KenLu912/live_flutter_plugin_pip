...
class GenerateTestUserSig {
   ...
   */
  static String PUSH_DOMAIN = "2157.livepush.myqcloud.com";
  /*
   *  配置拉流地址
   *  腾讯云域名管理页面： https://console.cloud.tencent.com/live/domainmanage
   */
  static String PLAY_DOMAIN = "2157.liveplay.myqcloud.com";
  /*
   * URL 鉴权Key
   */
   ...
   */
  static String LICENSEURL = "https://liteav.sdk.qcloud.com/app/res/licence/xiaozhibo/ios/RDM_Enterprise_hybrid.licence";
